...
/** [Update 9/12/2022]
 * I changed the function _parse_response to make sure that the response was parsed correctly. I also added a check to make sure that the last character of the parsed response was not a period.
 */
